...
import { BadgeCheck, Star, Swords } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-3 mt-3">
        ...
        <div className="border border-[rgba(255,255,255,0.1)] bg-[rgba(18,19,26,0.5)] backdrop-blur-[20px] rounded flex flex-col p-6 col-span-1 md:col-span-12">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-8">
            <div>
              <h2 className="font-heading text-[24px] font-semibold text-on-surface">Your Vault</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {series.map((series) => (
              <div className="relative aspect-[2/3] rounded border border-[rgba(255,255,255,0.1)] overflow-hidden bg-surface-container cursor-pointer transition-all duration-300 hover:scale-[1.02] hover:border-secondary hover:shadow-[0_0_15px_rgba(76,215,246,0.3)] group" key={series.id}>
                <img alt="Poster" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" src={series.image} />
                ...
                <div className="absolute bottom-0 left-0 w-full p-3 flex flex-col gap-1">
                  <div className="flex items-center justify-between">
                    <h3 className="font-heading text-[14px] font-semibold text-white line-clamp-2">{series.name}</h3>
                    <div className="flex items-center gap-0.5 text-tertiary">
                      <Star width={15} height={15}/>
                      <span className="text-[15px] font-semibold">{series.rating}</span>
                    </div>
                  </div>
                </div>
              </div>
